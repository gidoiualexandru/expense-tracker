...
<div class="max-w-3xl mx-auto mt-10 bg-white shadow rounded-lg p-8">
    <h1 class="text-2xl font-bold mb-6 text-center">Create New Savings Goal</h1>
    <form action="{{ route('savings.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="target_amount" id="target_amount" value="{{ old('target_amount') }}" step="0.01" required
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
            @error('target_amount')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        ...
        <div class="mb-4">
            ...
            <input type="number" name="current_amount" id="current_amount" value="{{ old('current_amount', 0) }}" step="0.01"
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="flex justify-end mt-6">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600">Save</button>
        </div>
    </form>
</div>
@endsection
